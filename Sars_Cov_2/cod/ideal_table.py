...
df['GenName'][(265 < df.Pos) & (df.Pos < 21556)] = 'ORF1ab'
df['GenType'][(265 < df.Pos) & (df.Pos < 21556)] = 'translated'
df['GenType'][df.Pos == 13468] = 'translated_shift'
num_codon = 1
k = 1
for i in range(13468 - 265 - 1):
    if 1 <= k and k <= 3:
        ...
        nuc_in_codon.append(k)
        k += 1
nuc_in_codon.append([k, 1])
nuc_in_codon.append([k, 1])
nuc_in_codon.append([k, 1])
k = 2
for i in range(21556 - 13468 - 1):
    if 1 <= k and k <= 3:
        nuc_in_codon.append(k)
        nuc_in_codon.append(k)
        nuc_in_codon.append(k)
...
df['GenName'][(21555 < df.Pos) & (df.Pos < 21563)] = 'ORF1ab-S_space'
df['GenType'][(21555 < df.Pos) & (df.Pos < 21563)] = 'untranslated'

for i in range(21563 - 21555 - 1):
    nuc_in_codon.append('None')
    nuc_in_codon.append('None')
    nuc_in_codon.append('None')
...
for index, row in df.iterrows():
    if df['GenType'][index] == 'translated_shift':
        ...
        ref_aa_a = coding_dna_a.translate()
        ref_aa_b = coding_dna_b.translate()
        df['RefAa'][index] = [[ref_aa_a], [ref_aa_b]]
        ...
        alt_aa_a = altaa_a.translate()
        alt_aa_b = altaa_b.translate()
        df['AltAa'][index] = [[alt_aa_a], [alt_aa_b]]
    ...
    if index == 40404 or index == 40405 or index == 40406:
        df['RefCodon'][index] = df['RefCodon'][index-3][1]
    if index == 40407 or index == 40408 or index == 40409:
        df['RefCodon'][index] = df['RefCodon'][index-6][1]
    if (df['GenType'][index] == 'translated') and (df['Pos'][index] != 27760) and (df['Pos'][index] != 27761) and (df['Pos'][index] != 13469) and (df['Pos'][index] != 13470):
    ...
    if df['GenType'][index] == 'translated_shift':
        if index == 40401:
            ...
            df['CodonNumber'][index+3] = codon_number+1
            df['CodonNumber'][index+4] = codon_number+1
            df['CodonNumber'][index+5] = codon_number+1
            df['CodonNumber'][index+6] = codon_number+1
            df['CodonNumber'][index+7] = codon_number+1
            df['CodonNumber'][index+8] = codon_number+1
            codon_number+=2
        elif index == 83265:
