...
for (gen in unique(ann$GenName)){
  ...
  png(sprintf('D:/Sars_Cov_2_MutSpec-main/Sars_Cov_2_MutSpec-main/Sars_Cov_2/R_figure/03.MutSpec12_%s.png', gen))
  barplot(MutSpec12Comp$MutSpec, names =  MutSpec12Comp$NucSubst, main = sprintf('Covid Mut spec 12 components in %s', gen), cex.names = 0.7)
  dev.off()
}
